...
import com.alvin.health.magager.HeartBeatManager;
import com.alvin.health.magager.UserInfoManager;
import com.alvin.health.model.HeartBeat;
import com.alvin.health.utils.AppTool;
import com.alvin.health.utils.UtilTime;
import com.alvin.health.view.LoveView;
import com.alvin.health.view.MyChart;
...
public class PhoneMainActivity extends Activity implements DataApi.DataListener
    ...
    //heart beat data storage and up to service
    HeartBeatManager mBeatManager;
    UserInfoManager mUserManager;
    //time control
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                ...
                .build();
        mChartLayout.addView(new LoveView(getApplicationContext()));
        //        mChart = new MyChart(getApplicationContext());
        //        mChartLayout.addView(mChart.getChartView()
        //                , new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT
        //                , ViewGroup.LayoutParams.MATCH_PARENT));

        mBeatManager = HeartBeatManager.getInstance(getApplicationContext());
        mUserManager = UserInfoManager.getInstance(getApplicationContext());
                    ...
                    .setResultCallback(new ResultCallback<MessageApi.SendMessageResult>() {
                        ...
                        public void onResult(MessageApi.SendMessageResult sendMessageResult) {
                            if (sendMessageResult.getStatus().isSuccess()) {
                                ...
                                Toast.makeText(PhoneMainActivity.this, "Send Message Success"
                                        , Toast.LENGTH_SHORT).show();
                            } else {
                                Log.d(TAG, "sendMessage Fail:" + context + "->"
                                        + sendMessageResult.getStatus()
                                        .getStatusMessage());
                                Toast.makeText(PhoneMainActivity.this, "Send Message Fail"
                                        , Toast.LENGTH_SHORT).show();
                            }
    ...
    private HeartBeat heartBeat(String data,String time,int mode){
        HeartBeat heartBeat = new HeartBeat();
        heartBeat.setTesttime(time);
        heartBeat.setMode(mode);
        heartBeat.setPhone(mUserManager.getUserInfo().getPhone());
        heartBeat.setCreatetime(UtilTime.getCurrentDateTime());
        heartBeat.setBeat(Float.valueOf(data));
        return heartBeat;
    }
}
